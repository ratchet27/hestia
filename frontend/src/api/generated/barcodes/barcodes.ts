 ...
 */
export const getApiProductsBarcodesList = async (uuid: string, options?: Parameters<typeof apiFetch>[1]): Promise<getApiProductsBarcodesListResponse> => {
...
export const postApiProductsBarcodesCreate = async (uuid: string,
    createBarcodeRequest: CreateBarcodeRequest, options?: Parameters<typeof apiFetch>[1]): Promise<postApiProductsBarcodesCreateResponse> => {
 ...
 */
export const getApiBarcodesLookup = async (code: string, options?: Parameters<typeof apiFetch>[1]): Promise<getApiBarcodesLookupResponse> => {
 ...
 */
export const deleteApiBarcodesDelete = async (code: string, options?: Parameters<typeof apiFetch>[1]): Promise<deleteApiBarcodesDeleteResponse> => {
