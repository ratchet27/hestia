 ...
 */
export const getApiCategoriesList = async ( options?: Parameters<typeof apiFetch>[1]): Promise<getApiCategoriesListResponse> => {
 ...
 */
export const postApiCategoriesCreate = async (saveCategoryRequest: SaveCategoryRequest, options?: Parameters<typeof apiFetch>[1]): Promise<postApiCategoriesCreateResponse> => {
 ...
 */
export const deleteApiCategoriesDelete = async (uuid: string, options?: Parameters<typeof apiFetch>[1]): Promise<deleteApiCategoriesDeleteResponse> => {
...
export const patchApiCategoriesUpdate = async (uuid: string,
    saveCategoryRequest: SaveCategoryRequest, options?: Parameters<typeof apiFetch>[1]): Promise<patchApiCategoriesUpdateResponse> => {
